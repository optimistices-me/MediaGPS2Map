...
/**
 * Format an ISO-8601 timestamp as a localised UTC+8 string.
 * @param {string} isoStr
 * @returns {string}
 */
export function toUTC8(isoStr) {
  const d = new Date(isoStr + '+08:00');
  return d.toLocaleString('zh-CN', { hour12: false });
}

/**
 * Convert WGS-84 coordinates to GCJ-02 (Chinese map offset).
 * Algorithm matches the Python implementation in geo_utils.py.
 * @param {number} lat
 * @param {number} lng
